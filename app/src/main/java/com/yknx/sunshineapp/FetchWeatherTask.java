...
public class FetchWeatherTask extends AsyncTask<String, Void, String[]> {
    ...
    private String formatHighLows(double high, double low) {
        ...
        String unitType = sharedPrefs.getString(
                mContext.getString(R.string.pref_key_tunits),
                mContext.getString(R.string.pref_default_tunits));

        if (!unitType.equals(mContext.getString(R.string.pref_default_tunits))) {
            high = (high * 1.8) + 32;
            low = (low * 1.8) + 32;
        }
...
// "temp" when working with temperature. It confuses everybody.
    ...
    private long addLocation(String locationSetting, String cityName, double lat, double lon){
        ...
        if(cursor.moveToFirst()){
            ...
            ContentValues values = Utility.createLocationValues(locationArg[0], locationArg[1], cityName, lat, lon);
        ...
        Log.v(LOG_TAG,"Location with id: "+locationRowId);
